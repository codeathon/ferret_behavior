...
from src.kinematics_core.quaternion_trajectory_model import QuaternionTrajectory
from src.kinematics_core.rigid_body_state_model import RigidBodyState
from src.kinematics_core.timeseries_model import Timeseries
from src.kinematics_core.vector3_trajectory_model import Vector3Trajectory
from src.kinematics_core.angular_velocity_trajectory_model import AngularVelocityTrajectory
from src.kinematics_core.angular_acceleration_trajectory_model import AngularAccelerationTrajectory
...
class RigidBodyKinematics(BaseModel):
    ...
    def save_to_disk(self, output_directory:str|Path):
        from src.kinematics_core.kinematics_serialization import save_kinematics
    ...
    def load_from_disk(self, kinematics_csv_path:str|Path, reference_geometry_json_path:str|Path) -> "RigidBodyKinematics":
        from src.kinematics_core.kinematics_serialization import load_kinematics
