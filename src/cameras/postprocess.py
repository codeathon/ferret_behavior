...
from src.cameras.synchronization.timestamp_synchronize import TimestampSynchronize
...
def postprocess(session_folder_path: Path, include_eyes: bool = True):
    ...
    """
    from src.video_viewing.combine_basler_videos import combine_videos, create_video_info
...
def old_postprocess(session_folder_path: Path):
    ...
    from src.video_viewing.combine_videos import combine_videos, create_video_info
