...
from src.ferret_gaze.calculate_gaze.ferret_gaze_kinematics import FerretGazeKinematics
from src.ferret_gaze.eye_kinematics.eye_kinematics_rerun_viewer import (
    COLOR_LEFT_EYE_PRIMARY,
    COLOR_LEFT_EYE_SECONDARY,
    COLOR_RIGHT_EYE_PRIMARY,
    COLOR_RIGHT_EYE_SECONDARY,
)
from src.ferret_gaze.eye_kinematics.ferret_eye_kinematics_models import (
    FerretEyeKinematics,
)
...
from src.rerun_viewer.rerun_utils.gaze_plots.plot_ferret_skull_and_spine_3d import load_toy_data_from_tidy_csv
from src.rigid_body_solver.viz.ferret_skull_rerun import (
    RAD_TO_DEG,
