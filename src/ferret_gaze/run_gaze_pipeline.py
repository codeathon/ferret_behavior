...
from src.ferret_gaze.calculate_gaze.calculate_ferret_gaze import calculate_ferret_gaze
...
from src.ferret_gaze.data_resampling.ferret_data_resampler import (
    VideoConfig,
