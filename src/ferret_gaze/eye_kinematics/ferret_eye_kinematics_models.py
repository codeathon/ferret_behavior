...
class TrackedPupil(BaseModel):
    ...
    def pupil_axes_mm(self) -> NDArray[np.float64]:
        ...
        """
        from src.ferret_gaze.eye_kinematics.ferret_eye_kinematics_functions import (
...
class FerretEyeKinematics(BaseModel):
    ...
    def load_from_directory(cls, eye_name: str, input_directory: str | Path) -> "FerretEyeKinematics":
        from src.ferret_gaze.eye_kinematics.ferret_eye_kinematics_serialization import (
