...
from src.video_viewing.closest_pupil_frame_to_basler_frame import closest_pupil_frame_to_basler_frame
from src.video_viewing.combine_videos import VideoInfo, VideoType, ROTATIONS
...
if __name__ == "__main__":
    recording_path = Path("/home/scholl-lab/ferret_recordings/session_2025-10-20_ferret_420_E010")
    clip_folder = recording_path / "clips/2m_00s-3m_00s"
