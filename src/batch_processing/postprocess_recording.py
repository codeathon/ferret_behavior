...
from src.rigid_body_solver.ferret_skull_solver import run_ferret_skull_solver_from_recording_folder
from src.utilities.find_bad_eye_data import bad_eye_data
