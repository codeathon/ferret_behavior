...
from src.animal_tracking.multi_video_labeller.helpers.video_models import ClickData, VideoPlaybackState
...
if __name__=="__main__":
    import cv2
    from src.animal_tracking.multi_video_labeller.helpers.video_models import VideoMetadata, VideoScalingParameters

    video_paths = Path(Path.home() / "freemocap_data/recording_sessions/freemocap_test_data/synchronized_videos").glob("*.mp4")
    config_file_path = Path("src/animal_tracking/multi_video_labeller/helpers/face_points.json")
