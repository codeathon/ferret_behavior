...
print(f"Looking for module at: {_project_root / 'src'}\n")

try:
    from src.blender_stuff.blender_helpers import create_parent_empty, clear_scene
    from src.blender_stuff.create_empties import create_trajectories
    from src.blender_stuff.load_trajectories import load_trajectories_auto
    from src.blender_stuff.create_eye_tracking_driver import create_eye_tracking_controller
