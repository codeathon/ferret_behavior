...
from src.ferret_gaze.eye_kinematics.eye_kinematics_rerun_viewer import COLOR_LEFT_EYE_PRIMARY, COLOR_LEFT_EYE_SECONDARY, COLOR_RIGHT_EYE_PRIMARY, COLOR_RIGHT_EYE_SECONDARY, set_time_seconds
...
def plot_gaze_traces(
    ...
    horizontal = kinematics.horizontal_degrees
    vertical = kinematics.vertical_degrees
