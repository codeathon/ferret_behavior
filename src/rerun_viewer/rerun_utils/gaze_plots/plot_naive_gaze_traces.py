...
from src.ferret_gaze.eye_kinematics.eye_kinematics_rerun_viewer import set_time_seconds
from src.ferret_gaze.eye_kinematics.ferret_eye_kinematics_models import FerretEyeKinematics
from src.kinematics_core.reference_geometry_model import ReferenceGeometry
from src.rerun_viewer.rerun_utils.gaze_plots.plot_gaze_traces import (
    COLOR_LEFT_EYE_PRIMARY,
    COLOR_LEFT_EYE_SECONDARY,
    COLOR_RIGHT_EYE_PRIMARY,
    COLOR_RIGHT_EYE_SECONDARY,
)
from src.rigid_body_solver.viz.ferret_skull_rerun import RAD_TO_DEG, load_kinematics_from_tidy_csv
