...
from src.rerun_viewer.rerun_utils.gaze_plots.plot_3d_eye import (
    plot_3d_eye,
    get_3d_eye_view,
)
from src.rerun_viewer.rerun_utils.gaze_plots.plot_eye_traces import (
    plot_eye_traces,
    get_eye_trace_views,
    log_eye_trace_style,
)
from src.rerun_viewer.rerun_utils.gaze_plots.plot_eye_video import plot_eye_video, get_eye_video_view
from src.rerun_viewer.rerun_utils.gaze_plots.plot_ferret_skull_and_spine_3d import (
    log_ferret_skull_and_spine_3d_style,
    plot_ferret_skull_and_spine_3d,
    get_ferret_skull_and_spine_3d_view,
)
from src.rerun_viewer.rerun_utils.gaze_plots.plot_ferret_skull_and_spine_traces import (
    log_ferret_skull_and_spine_traces_style,
    plot_ferret_skull_and_spine_traces,
    get_ferret_skull_and_spine_traces_views,
)
from src.rerun_viewer.rerun_utils.gaze_plots.plot_gaze_traces import get_gaze_trace_views, log_gaze_trace_style, plot_gaze_traces
from src.rerun_viewer.rerun_utils.gaze_plots.plot_naive_gaze_traces import get_naive_gaze_trace_views, log_naive_gaze_trace_style, plot_naive_gaze_traces
from src.rerun_viewer.rerun_utils.video_data import AlignedEyeVideoData
...
if __name__ == "__main__":
    recording_folder = RecordingFolder.from_folder_path(
        "/Users/philipqueen/Documents/GitHub/bs/src/ferret_gaze/calculate_gaze/synthetic_test_data/combined/full_recording"
    )
    eye_to_plot = "left"
